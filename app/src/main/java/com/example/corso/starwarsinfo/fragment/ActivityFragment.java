...
public class ActivityFragment extends Fragment {
    ...
    private ContractActivityFragment.View mListener;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        peopleText = (TextView) view.findViewById(R.id.people_text);
        peopleText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.onPeopleClicked();
            }
        });
        planetsText = (TextView) view.findViewById(R.id.planets_text);
        planetsText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.onPlanetsClicked();
            }
        });
        starshipsText = (TextView) view.findViewById(R.id.starships_text);
        starshipsText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.onStarshipsClicked();
            }
        });
    }
    ...
    public void onAttach(Context context) {
        ...
        try{
            mListener = (ContractActivityFragment.View) context;
